...
public class User {
    ...
    public void addCreatedModule(ModuleInfo moduleInfo) {
        createdModules.add(moduleInfo);
        moduleInfo.setCreator(this);
    }

    public void removeCreatedModule(ModuleInfo moduleInfo) {
        createdModules.remove(moduleInfo);
        moduleInfo.setCreator(null);
    }
